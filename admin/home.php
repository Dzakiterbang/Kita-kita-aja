...
<div class="col-md-3">
      <div class="card">
        ...
        <div class="card-footer text-center">
          <a href="../config/proses-like.php?fotoid=<<?php echo $data['fotoid'] ?>" type="submit" name="suka"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
          ...
          $fotoid = $data['fotoid'];
           ...
           ?>
          <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-dots" viewBox="0 0 16 16">
